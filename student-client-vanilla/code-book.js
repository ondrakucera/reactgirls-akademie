...
export const getCodeBookOptionsString = (codeBooks, codeBookCode, language, checkedValue, withEmpty = false) =>
...
export const getCodeBookRadioButtonsString = (codeBooks, codeBookCode, language, checkedValue) =>
